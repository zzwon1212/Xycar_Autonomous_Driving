    ...
    def run(self):
        ...
        for i, batch in enumerate(self.eval_loader):
            ...
            with torch.no_grad():
                ...
                # origin 0.1, 0.5 // demo 0.4 0.45
                best_box_list = non_max_suppression(output, conf_thres=0.5, iou_thres=0.5)

            # origin 0.5 // demo 0.001
            predict_all += get_batch_statistics(best_box_list, targets, iou_threshold=0.001)
        ...
        # class_names = [self.class_str[c] for c in ap_class]
