...
def drawBoxlist(_img, boxes : list = [], mode : int = 0, name : str = ""):
    ...
    for box in boxes:
        if mode == 0:
            ...
            # draw.text((box[0],box[1]), str(int(box[5]))+","+str(int(box[4]*100)), fill ="red", font=font)
            if int(box[5]) == 0:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(0,255,255), width=1)
                draw.text((box[0],box[1]), "left"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 1:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(204,0,255), width=1)
                draw.text((box[0],box[1]), "right"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 2:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(0,0,255), width=1)
                draw.text((box[0],box[1]), "crosswalk"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 3:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(204,51,0), width=1)
                draw.text((box[0],box[1]), "stop"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 4:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(0,255,0), width=1)
                draw.text((box[0],box[1]), "car"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 5:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(255,0,0), width=1)
                draw.text((box[0],box[1]), "trafficRed"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 6:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(0,153,0), width=1)
                draw.text((box[0],box[1]), "trafficGreen"+","+str(int(box[4]*100)), fill ="red", font=font)
            elif int(box[5]) == 7:
                draw.rectangle((box[0],box[1],box[2],box[3]), outline=(255,255,0), width=1)
                draw.text((box[0],box[1]), "trafficYellow"+","+str(int(box[4]*100)), fill ="red", font=font)
    #img_data.show("draw")
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None):
    ...
    nc = prediction.shape[2] - 5  # number of classes: 13 - 5 = 8
